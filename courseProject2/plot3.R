...
# Which have seen increases in emissions from 1999â€?2008? Use the ggplot2 plotting system to 
...
qplot(year, V1, data=Baltimore_emssions_each_year_type,facet=.~type)+geom_line()+labs(title="Emssions in Baltimore City")+labs(y="total emssions")+facet_wrap(~type, nrow = 2, ncol = 2)
dev.off()
